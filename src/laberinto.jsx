...
import Fantasma from './ghost';
import Goal from './final';
    ...
    <div onKeyDown={handleKeyDown} tabIndex="0">
      <div style={containerStyle}>
        ...
        <div style={settingsStyle}>
          ...
          <h4>Ancho:</h4>
          <input type="number" id="ancho" name="quantity" defaultValue={width} min="2" max="10" onChange={(e) => setWidth(e.target.value)} />
      ...
      <div style={style}>
        {laberinto.map((row, rowIndex) => row.map((column, columnIndex) => {
